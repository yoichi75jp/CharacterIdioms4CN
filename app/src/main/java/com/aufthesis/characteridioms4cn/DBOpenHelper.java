...
{
    static private int DB_VERSION = 1;  //2018/03/30 ver.1
    final static private String DB_NAME = "idiom4_cn";
    final static private String DB_NAME_ASSET = "idiom4_cn.db";
    final static private String DB_NAME_ZIP = "idiom4_cn.zip";
